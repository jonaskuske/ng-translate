...
@Component({
	...
	template: `
		...
		<db-headline variant="3"
			>Verantwortlich für Inhalte gemäß 55 Abs. 2 RStV</db-headline
		>
		...
		<p>
			...
			Rechtsverletzungen werde ich derartige Links umgehend entfernen. Die durch
			die Seitenbetreiber erstellten bzw. verwendeten Inhalte und Werke auf
