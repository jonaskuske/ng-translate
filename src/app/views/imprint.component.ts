...
@Component({
	...
	template: `
		<db-headline pulse variant="1">Impressum</db-headline>
		<db-headline variant="2">Angaben gemäß §5 TMG</db-headline>
		<p>Jonas Kuske, 69120 Heidelberg</p>
		<db-headline variant="3">Verantwortlich für Inhalte gemäß 55 Abs. 2 RStV</db-headline>
		<p>Jonas Kuske<br />Schulzengasse 11, 69120 Heidelberg</p>
		<db-headline variant="3">Kontakt</db-headline>
		<p>Telefon: +491603336948</p>
		<p>Mail: mail&#64;jonaskuske.com</p>

		<db-headline variant="2">Haftungsausschluss</db-headline>
		<db-headline variant="3">Haftung für Inhalte</db-headline>
		<p>
		...
		<db-headline variant="3">Haftung für Links</db-headline>
		<p>
			...
			Rechtsverletzungen werde ich derartige Links umgehend entfernen. Die durch die Seitenbetreiber
			erstellten bzw. verwendeten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen
			Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung
			außerhalb der Grenzen des Urheberrechtes bedürfen der Zustimmung des jeweiligen Autors bzw.
